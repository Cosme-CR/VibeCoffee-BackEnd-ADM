...
router.post("/", boddyParserJSON, async function(request,response){
    ...
    let result = await controllerCategoria.inserirNovaCategoria(dados, conteType)
...
router.put("/:id", boddyParserJSON, async function(request,response){
    ...
    let result = await controllerCategoria.atualizarCategoria(
        dados,
        id,
        contentType
    )
...
router.delete("/:id", async function(request,response){
    ...
    let result = await controllerCategoria.apagarCategoria(id)
